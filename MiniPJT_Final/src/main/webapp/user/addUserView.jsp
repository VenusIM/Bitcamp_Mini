	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <c:if test="${empty user.userImage }">
		     ...
		     <img src="${user.userImage}"/>
			     <div class="col-sm-4">
			     	<input type="text" class="form-control" id="kakaoId" name="userId" value="${user.email }" readonly>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="userName" name="userName" value="${user.userName}" placeholder="회원이름">
		    </div>
		  </div>
